...
<div class="top">
  <div class="bar black card">
    ...
    <a href="images/pro.html" class="bar-item button padding-large hide-small">GALLERY</a>
    <a href="Admin.php" class="bar-item button padding-large hide-small">ADMIN</a>
    <?php if (isset($_SESSION)): ?>
      <a onclick="document.getElementById('Logout').style.display='block'" class="padding-large button hover-red hide-small right"><?php print_r($_SESSION["user"]);?></a>
    <?php else: ?>
      <a onclick="document.getElementById('Login').style.display='block'" class="padding-large button hover-red hide-small right">LOG IN</a>
    <?php endif; ?>
  </div>
...
<div id="navDemo" class="bar-block black hide hide-large hide-medium top" style="margin-top:46px">
  ...
  <a href="pro.php" class="bar-item button padding-large hide-small">GALLERY</a>
  <?php if (isset($_SESSION)): ?>
...
<div class="content" style="max-width:2000px;margin-top:46px">
  ...
  <div class="container content center padding-64" style="max-width:800px" id="band">
    ...
    <div class="row padding-32">
      ...
      <div class="third">
        <p>Jayden</p>
        <img src="Artist/spiderman.jpg" class="round margin-bottom" alt="Random Name" style="width:60%">
      </div>
    </div>
  </div>
